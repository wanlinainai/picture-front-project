...
<template>
  <div class="picture-search-form">
    <!--    搜索表单-->
    <a-form layout="inline" :model="searchParams" @finish="doSearch" :style="{ rowGap: '13px', columnGap: '13px' }">
      ...
      <a-form-item>
        ...
        <a-button html-type="reset" @click="doClear" style="margin-left: 16px">重置</a-button>
      </a-form-item>
    </a-form>
  </div>
</template>
